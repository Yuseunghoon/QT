...
int setupDSP(snd_pcm_t *dev, int buf_size, int format, int sampleRate, int channels)
{
    ...
    {
        perror("Cound not sample format");
        return -1;
    }
    ...
    {
        perror("Cound not set buffer_size");
        return -1;
    }
    ...
    {
        perror("Cound not set HW params");
        return -1;
    }
