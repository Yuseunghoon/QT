...
int main(int argc, char** argv) 
{
    ...
    IplImage *image3 = cvCreateImage(cvGetSize(image1), 8, 3);
    IplImage *image4 = cvCreateImage(cvGetSize(image1), 8, 3);
    IplImage *image5 = cvCreateImage(cvGetSize(image1), 8, 3);
